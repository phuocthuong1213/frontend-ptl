                ...
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <div className="page-header-content header-elements-md-inline">
                        <div className="page-title d-flex">
                            <h4><i className="fas fa-question-circle i-space mr-2"></i> <span className="font-weight-semibold">Quản lý câu hỏi</span></h4>
                    ...
                    <div className="col-md-12">
                        <div className="card text-dark">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <span><i className="fas fa-book i-space mr-2"></i>Danh sách câu hỏi</span>
                                <Link href="/question/add"><a className="btn btn-primary btn-sm"><i className="fas fa-book-medical mr-2"></i>Thêm câu hỏi</a></Link>
                            </div>
                                    ...
                                    <table className="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr className="text-dark text-center">
                                                ...
                                                <td>
                                                    <Link href="/question/update"><a className="btn btn-warning btn-sm px-1 py-0 mr-2" title="Sửa"><i className="fas fa-edit"></i></a></Link>
...
export default IndexQuestionComponent